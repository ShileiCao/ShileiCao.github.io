...
1. **Transfer Learning for Vision Models**
   - **Test-Time Adaptation**: [AMROD](https://arxiv.org/abs/2406.16439) <small style="color:#96CDCD">(under review)</small>,  LSCD-TTA <small style="color:#ADD8E6">(JAG '25)</small>, TTA-FedDG <small style="color:#666">(AAAI '25)</small>
