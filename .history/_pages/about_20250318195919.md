...
1. **Transfer Learning for Vision Models**
   - **Test-Time Adaptation**: [AMROD](https://arxiv.org/abs/2406.16439) <small style="color:#96CDCD">(under review)</small>,  LSCD-TTA <small style="color:#ADD8E6">(JAG '25)</small>, TTA-FedDG <small style="color:#D1EEEE">(AAAI '25)</small>
  
   - **Domain Generalization**:  TTA-FedDG <small style="color:#008B8B">(AAAI '25)</small>, AABAW <small style="color:#4682B4">(ICME '25)</small>
   - **Parameters-Efficient Fine-Tuning**:  ClimatePEFT <small style="color:#F0FFF0">(under review)</small>

2. **Spatio-Temporal Modeling**
   - **Weather and Climate**: ClimatePEFT <small style="color:#20B2AA">(under review)</small>, ResCast <small style="color:#76EEC6">(under review)</small> , TianQuan-Climate <small style="color:	#F0FFFF">(under review)</small>
   - **Remote Sensing**: [$A^2$-MAE](https://arxiv.org/abs/2406.08079) <small style="color:#666">(under review)</small>,  LSCD-TTA <small style="color:#D3D3D3">(JAG '25)</small>
