...
1. **Transfer Learning for Vision Models**
   ...
   - **Domain Generalization**:  TTA-FedDG <small style="color:#008B8B">(AAAI '25)</small>, AABAW <small style="color:#BEBEBE">(ICME '25)</small>
   - **Parameters-Efficient Fine-Tuning**:  ClimatePEFT <small style="color:#778899">(under review)</small>
