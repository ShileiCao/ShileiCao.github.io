...
1. **Transfer Learning for Vision Models**
   - **Test-Time Adaptation**: [AMROD](https://arxiv.org/abs/2406.16439) <small style="color:#9AC0CD">(under review)</small>,  LSCD-TTA <small style="color:#B4CDCD">(JAG '25)</small>, TTA-FedDG <small style="color:#D1EEEE">(AAAI '25)</small>
  
   - **Domain Generalization**:  TTA-FedDG <small style="color:#008B8B">(AAAI '25)</small>, AABAW <small style="color:#4682B4">(ICME '25)</small>
   - **Parameters-Efficient Fine-Tuning**:  ClimatePEFT <small style="color:#BEBEBE">(under review)</small>

2. **Spatio-Temporal Modeling**
   - **Weather and Climate**: ClimatePEFT <small style="color:#C6E2FF">(under review)</small>, ResCast <small style="color:#B9D3EE">(under review)</small> , TianQuan-Climate <small style="color:	#9FB6CD">(under review)</small>
