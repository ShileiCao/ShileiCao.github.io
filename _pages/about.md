...
1. **Transfer Learning for Vision Models**
   ...
   - **Parameters-Efficient Fine-Tuning**:  WeatherPEFT <small style="color:#B4CDCD">(ICLR '26)</small>, CrossEarth-Gate <small style="color:#B4CDCD">(CVPR '26)</small>.
...
<div class="news-box">
  <h1>News</h1>
  <ul>
      <li><strong>2026-02-21:</strong> One <a> First </a> author paper about parameter-efficient fine-tuning for cross-domain remote sensing semantic segmentation is accepted by <a href="https://cvpr.thecvf.com/">CVPR 2026</a>. Thanks the co-authors!</li>
...
[6] **Shilei Cao\***, Ziyang Gong\*, Hehai Lin, Yang Liu, Jiashun Cheng, Xiaoxing Hu, Haoyuan Liang, Guowen Li, Chengwei Qin, Hong Cheng, Xue Yang, Juepeng Zheng, Haohuan Fu.
